                ...
                <div class="leftside-menu leftside-menu-detached">
                    ...
                    <ul class="side-nav">
                        ...
                        <li class="side-nav-item">
                            <a  href="dashbord_en_dtn"  class="side-nav-link">
                        ...
                        <li class="side-nav-item">
                            <a href="dashbord_en_en" class="side-nav-link">
                        ...
                        <li class="side-nav-item">
                            <a href="dashbord_en_pp" class="side-nav-link">
                        ...
                        <li class="side-nav-item">
                            <a  href="dashbord_en_j" class="side-nav-link">
                        ...
                        <li class="side-nav-item">
                            <a  href="dashbord_en_form"  class="side-nav-link">
